...
namespace PMSAPI.Migrations
{
    ...
    [Migration("20230219145332_AddAppUserTypeAndPersonFKToAppUserTable")]
    partial class AddAppUserTypeAndPersonFKToAppUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS_API.Models.AppUserType", b =>
                {
                    b.Property<int>("AppUserTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AppUserTypeId"));
                    ...
                    b.ToTable("AppUserType", (string)null);
                });
            ...
            modelBuilder.Entity("PMS_API.Models.AppUser", b =>
                {
                    b.HasOne("PMS_API.Models.AppUserType", "AppUserType")
                        .WithMany()
                        .HasForeignKey("AppUserTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PMS_API.Models.Person", "AppUserPerson")
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUserPerson");
